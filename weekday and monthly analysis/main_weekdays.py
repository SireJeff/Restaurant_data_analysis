...
# Group by item and day of week, then sum the prices
print("Calculating total prices for each item by day of week...")
total_price_per_item_day = merged_df.groupby(['Esm', 'DayOfWeek'])[price_column].sum().unstack().fillna(0)

print("Total price per item by day of week:\n", total_price_per_item_day)

# Save the results to a new Excel file
print("Saving results to Excel files...")
total_price_per_item_day.to_excel('Total_Price_Per_Item_Day.xlsx')
